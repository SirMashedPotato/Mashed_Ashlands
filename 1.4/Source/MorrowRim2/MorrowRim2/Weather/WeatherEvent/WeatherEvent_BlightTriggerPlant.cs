...
namespace MorrowRim2
{
    public class WeatherEvent_BlightTriggerPlant : WeatherEvent
    {
        ...
        public void SendLetter(List<Plant> plants)
        {
            ...
            Find.LetterStack.ReceiveLetter("MorrowRim_TheAshlands_BlightedPlants_Label".Translate(), "MorrowRim_TheAshlands_BlightdPlants_Description".Translate() + plantDetails.ToString(), LetterDefOf.MorrowRim_VolcanoNegativeEvent, plants, null, null);
        }
